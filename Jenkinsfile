    ...
    stage('Management API Tests') {
      steps {
        script {
          ...
          server_image.inside("${node_env} ${management_api_mode} ${db_storage_path_process_model} ${db_storage_path_flow_node_instance} ${db_storage_path_timer} ${junit_report_path} ${config_path}") {
